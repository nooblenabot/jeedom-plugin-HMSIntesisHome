        ...
        <form class="form-horizontal">
          <fieldset>
            <div class="col-lg-6">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label">{{Type d'IntesisBox}}

                </label>
                <div class="col-sm-6">
                  <select id="typeEq" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="IntesisBox_Type">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label">{{Port Communication}}
                  <sup><i class="fas fa-question-circle tooltips" title="{{Port de communication. laisser 3310 par default}}"></i></sup>
                </label>
                <div class="col-sm-6">
                  <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="portCom" placeholder="3310">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">{{Identifiant Climatiseur}}
                  <sup><i class="fas fa-question-circle tooltips" title="{{Identifiant du boitier. laisser 1 par default}}"></i></sup>
              </label>
                <div class="col-sm-6">
                  <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="AcNum" placeholder="1">
                </div>
              </div>
              <div class="form-group">
